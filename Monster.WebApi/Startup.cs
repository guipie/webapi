...
namespace Monster.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "诡瞥社区后台Api", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "诡瞥社区后台Api");
            });
            app.UseRouting();
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapHub<MovieWebsiteServiceHub>("/api/SignalR/CrawlingHub");
            });
        }
    }
}
