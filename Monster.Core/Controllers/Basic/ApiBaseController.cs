...
namespace Monster.Core.Controllers.Basic
{
    ...
    public class ApiBaseController<IServiceBase> : BaseController<IServiceBase>
    {
       ...
       : base(service)
        ...
        public virtual async Task<ActionResult> GetOneRes(object id)
        {
            return await base.GetOneResponse(id);
        }
        [HttpGet, Route("Get/{id}")]
        public virtual async Task<ActionResult> GetOneModel(int id)
        {
            return await base.GetOneEntity(id);
        }
