...
namespace Monster.Core.Extensions
{
    public static class ConvertJsonExtension
    {
        ...
        public static JArray ToJArray(this IList list)
        {

            var jsonSetting = new JsonSerializerSettings { NullValueHandling = NullValueHandling.Include, DateFormatString = "yyyy-MM-dd HH:mm:ss.fff" };
