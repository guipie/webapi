...
namespace Monster.Core.Filters
{
    public abstract class ServiceFunFilter<T> where T : class
    {
        ...
        /// 默认上传文件大小限制3M
        /// </summary>
        protected int LimitUpFileSizee { get; set; } = 100;
        ...
        protected Func<object[], WebResponseContent> QueryOnExecuting;


        protected Func<object[], WebResponseContent> QueryOnExecuted;
